...
export const getInvoice = async (shopId:string, invoiceId: string): Promise<InvoiceResponse> => {
  const response = await api.get<InvoiceResponse>(`/shops/${shopId}/invoices/${invoiceId}`);
  return response.data;
};

export const updateInvoice = async (shopId:string, invoiceId: string, data: CreateInvoiceRequest): Promise<InvoiceResponse> => {
  const response = await api.put<InvoiceResponse>(`/shops/${shopId}/invoices/${invoiceId}`, data);
  return response.data;
};

export const deleteInvoice = async (shopId:string, invoiceId: string): Promise<void> => {
  await api.delete(`/shops/${shopId}/invoices/${invoiceId}`);
};
